...
//Atribui projétil ao jogador
if (alive _jogador) then {	
	_rocket setShotParents [vehicle _jogador, _jogador];
};
...
//Deleta alvo e libera uso para outros jogadores
if (!isNull _target) exitWith {
	deleteVehicle _target;
	missionNamespace setVariable ["SMQTV_mk41EmUso", false, true];
	"|| Mk-41 VLS liberado para uso ||" remoteExecCall ["systemChat"];
};